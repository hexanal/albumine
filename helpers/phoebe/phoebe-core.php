 ...
 *
 * @param WP_Post $item a object of the currentlyr-looked-into `nav_menu_item`
...
function phoebe_get_menu_item_info($item, $menu_items) {
  ...
  return array(
    'id' => $item_id,
    'page-id' => $item->object_id, // that the actual page ID that the menu item points to
    'label' => $item->title,
    'is-active' => $is_active,
 ...
 *
 * @param WP_Post a `nav_menu_item` post object
